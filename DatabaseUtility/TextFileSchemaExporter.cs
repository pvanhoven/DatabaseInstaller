...
namespace DatabaseUtility {
    public class TextFileSchemaExporter : ISchemaExporter {
        private readonly IDbScripter scripter;
        private readonly IDirectoryService directoryService;

        public TextFileSchemaExporter(IDbScripter scripter, IDirectoryService directoryService) {
